...
-record(state,
        {container_defs = [], active_containers = [], lifecycle = suite :: ct_lifecycle()}).
...
pre_init_per_testcase(_SuiteName,
                      _TestCase,
                      Config,
...
post_end_per_testcase(_SuiteName,
                      _TestCase,
                      Config,
                      _Return,
